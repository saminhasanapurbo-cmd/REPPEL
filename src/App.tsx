...
export const BUILD_ID = 'RIPPLE-V47-SOCIAL-REDESIGN';
  ...
  if (authLoading) {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
        ...
        <span className="mt-3 px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 text-[10px] font-bold border border-blue-100">v45</span>
      </div>
    );
  }
        ...
        <main className={`flex-1 min-w-0 min-h-screen flex flex-col bg-white border-r md:border-x border-slate-200/80 ${
          ...
          <header id="mobile-header" className="md:hidden sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200/80 px-4 h-14 flex items-center justify-between">
            ...
            >
              ...
              <span className="ml-1 text-[10px] text-slate-400 font-medium tracking-tight">v45</span>
            </div>
